                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #e6ded4;">
                    <tr>
                        <td style="padding:0; background:#1f1a17;">
                            <img src="{{ $heroImage }}" alt="La Barberia Di Salvatore Nappa" width="640" style="display:block; width:100%; max-width:640px; height:220px; object-fit:cover; border:0;">
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:34px 34px 10px;">
                            ...
                            <p style="margin:0; font-size:16px; line-height:1.7; color:#5d5148;">Ciao {{ $name }}, abbiamo ricevuto una richiesta per reimpostare la password del tuo account La Barberia Di Salvatore Nappa.</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:16px 34px 34px;">
                            ...
                            <p style="margin:14px 0 0; font-size:14px; line-height:1.6; color:#8a7460;">La Barberia Di Salvatore Nappa</p>
                        </td>
                    </tr>
                </table>
            </td>
