                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:760px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #e5e5e5;">
                    ...
                    <tr>
                        <td style="padding:34px 34px 10px;">
                            ...
                            <p style="margin:0; font-size:16px; line-height:1.7; color:#4b4b4b;">Ciao {{ $name }}, abbiamo ricevuto una richiesta per reimpostare la password del tuo account Gabriele Del Piano Barber.</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:16px 34px 34px;">
                            ...
                            <p style="margin:14px 0 0; font-size:14px; line-height:1.6; color:#666666;">Gabriele Del Piano Barber</p>
