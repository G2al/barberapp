                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #e6ded4;">
                    <tr>
                        <td style="padding:0; background:#1f1a17;">
                            <img src="{{ $heroImage }}" alt="La Barberia Di Salvatore Nappa" width="640" style="display:block; width:100%; max-width:640px; height:230px; object-fit:cover; border:0;">
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:34px 34px 10px;">
                            ...
                            <p style="margin:0; font-size:16px; line-height:1.7; color:#5d5148;">La tua prenotazione presso La Barberia Di Salvatore Nappa e&apos; stata confermata.</p>
                        </td>
                    </tr>
                    <tr>
