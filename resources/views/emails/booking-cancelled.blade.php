                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #e5e5e5;">
                    <tr>
                        <td style="padding:0; background:#111111;">
                            <img src="{{ $heroImage }}" alt="Giovanni Cerino Hair Stylist" width="640" style="display:block; width:100%; max-width:640px; height:210px; object-fit:cover; border:0;">
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:34px 34px 10px;">
                            ...
                            <h1 style="margin:16px 0 12px; font-size:28px; line-height:1.2; color:#111111;">Ciao {{ $name }}, abbiamo annullato la tua prenotazione.</h1>
                            <p style="margin:0; font-size:16px; line-height:1.7; color:#4b4b4b;">Ti confermiamo che la prenotazione indicata qui sotto non e&apos; piu&apos; attiva.</p>
                        </td>
                    </tr>
                    <tr>
